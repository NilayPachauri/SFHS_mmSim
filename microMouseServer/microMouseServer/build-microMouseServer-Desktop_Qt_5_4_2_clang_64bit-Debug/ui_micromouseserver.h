...
public:
    ...
    {
        microMouseServer->setWindowTitle(QApplication::translate("microMouseServer", "microMouseServer", 0));
        actionSave_Maze->setText(QApplication::translate("microMouseServer", "Save Maze", 0));
        menu_startRun->setText(QApplication::translate("microMouseServer", "Start Run", 0));
        actionTest->setText(QApplication::translate("microMouseServer", "test", 0));
        menu_loadMaze->setText(QApplication::translate("microMouseServer", "Load Maze", 0));
        menu_saveMaze->setText(QApplication::translate("microMouseServer", "Save Maze", 0));
        menu_connect2Mouse->setText(QApplication::translate("microMouseServer", "Connect to Local Mouse", 0));
        actionConnect_to_Remote_Mouse->setText(QApplication::translate("microMouseServer", "Connect to Remote Mouse", 0));
        tabWidget->setTabText(tabWidget->indexOf(tb_status), QApplication::translate("microMouseServer", "Status", 0));
        tabWidget->setTabText(tabWidget->indexOf(tb_debug), QApplication::translate("microMouseServer", "Debug", 0));
        menuSystem->setTitle(QApplication::translate("microMouseServer", "File", 0));
    } // retranslateUi
